...
public class MainUI extends javax.swing.JFrame {
    ...
    public void initcomponents() {
        ...
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("META-INF/com/google/android/AFZC.png")));
        ...
        btnAddCustomDpi.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void btnAddCustomDpiActionPerformed(ActionEvent evt) {
                ...
                JOptionPane.showMessageDialog(null, "Sorry! Currently this feature is unavailable..!!");
                //ChangeDpiUI();
            }
        });
